...
import (
	...
	"github.com/Astemirdum/library-service/backend/identity-provider/config"
	"github.com/Astemirdum/library-service/backend/identity-provider/internal/handler"
	"github.com/Astemirdum/library-service/backend/identity-provider/internal/repository"
	"github.com/Astemirdum/library-service/backend/identity-provider/internal/server"
	"github.com/Astemirdum/library-service/backend/identity-provider/internal/service"
	"github.com/Astemirdum/library-service/backend/identity-provider/migrations"
