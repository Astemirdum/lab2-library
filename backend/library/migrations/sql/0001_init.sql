...
INSERT INTO library (library_uid, name, city, address) VALUES
    ('93575e12-7ce0-48ee-9931-51919ff3c9ee', 'Библиотека имени 8', 'Москва', '3-я Бауманская ул., д.10, стр.1')
;

INSERT INTO books (book_uid, name, author, genre, condition) VALUES
    ('07cdc58f-2caf-4b15-9727-f89dcc629b27', 'Краткий курс C-- в 7 томах', 'Бьерн Страуструп', 'Научная фантастика', 'EXCELLENT')
;
