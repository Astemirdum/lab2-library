...
import (
	...
	ratingModel "github.com/Astemirdum/library-service/backend/rating/internal/model"
	ratingRepo "github.com/Astemirdum/library-service/backend/rating/internal/repository"
	"go.uber.org/zap"
)
...
func (s *Service) CreateRating(ctx context.Context, name string, stars int) error {
	return s.repo.CreateRating(ctx, name, stars)
}
